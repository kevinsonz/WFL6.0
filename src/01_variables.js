...
const gtdImakokoMonthCurrentCell = 'T1'; // GTD今ココ月（現在）番号
const gtdImakokoMonthNextCell = 'K2'; // GTD今ココ月（変更）番号
...
const gtdShiteiMonthNextCell = 'J4'; // GTD今ココ月or指定年月フラグ（変更）
const gtdShiteiYYYYNextCell = 'J5'; // GTD指定年度（変更）
const gtdShiteiMMNextCell = 'J6'; // GTD指定月（変更）
...
function calFormula(){
    ...
    if(nullFormula){
        calSheet.getRange('A'+(beginRow_Cal+1)+':A').setFormula('=iferror(if($NM'+(beginRow_Cal+1)+'=1,ifs(and($D$5=false,$D$6=false),1,and($D$5=true,$D$6=false),$NV'+(beginRow_Cal+1)+',and($D$5=false,$D$6=true),$NW'+(beginRow_Cal+1)+',and($D$5=true,$D$6=true),$NV'+(beginRow_Cal+1)+'*$NW'+(beginRow_Cal+1)+'),0),0)');
